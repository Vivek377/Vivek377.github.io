...
const GitStats = () => {
  return (
    <Box
      w={{ base: "100%" }}
      top={{ base: "28rem", md: "25rem" }}
      h={"90rem"}
      position={{ base: "relative" }}
      color={"whiteAlpha.800"}
      bg={"#1a202c"}
    >
      <Box w={{ base: "12rem", md: "20rem" }} m={"auto"} mt={{ base: "5rem" }}>
        <Text fontWeight={"semibold"} fontSize={"4xl"}>
          My github stats
        </Text>
      </Box>
      <Box w={"fit-content"} m={"auto"} mt={"5rem"} id="github-top-langs">
      ...
      <Box w={"fit-content"} m={"auto"} mt={"5rem"} id="github-streak-stats">
      ...
      <Box w={"fit-content"} m={"auto"} mt={"5rem"} id="github-stats-card">
      ...
      <Box w={"fit-content"} m={"auto"} mt={"5rem"}>
